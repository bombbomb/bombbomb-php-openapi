...
class VideoEmailPrompt implements ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['hasSocial'] = isset($data['hasSocial']) ? $data['hasSocial'] : null;
    ...
    /**
     * Sets sendMechanism
     * @param string $sendMechanism The sendMechanism property
     * @return $this
     */
    ...
    {
        return $this->container['hasSocial'];
    }

    /**
     * Sets hasSocial
     * @param bool $hasSocial this determines whether or not it has a social content.
     * @return $this
     */
    public function setHasSocial($hasSocial)
    {
        $this->container['hasSocial'] = $hasSocial;
