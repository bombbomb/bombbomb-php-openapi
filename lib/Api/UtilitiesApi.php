...
class UtilitiesApi
{
    ...
    public function createOAuthClientWithHttpInfo($name, $redirectUri)
    {
        ...
        $request = $this->createOAuthClientRequest($name, $redirectUri);
     ...
     */
    public function createOAuthClientAsync($name, $redirectUri)
    {
        return $this->createOAuthClientAsyncWithHttpInfo($name, $redirectUri)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createOAuthClientAsyncWithHttpInfo($name, $redirectUri)
    {
        $returnType = '\Swagger\Client\Model\OAuthClient';
        $request = $this->createOAuthClientRequest($name, $redirectUri);
     ...
     */
    protected function createOAuthClientRequest($name, $redirectUri)
    {
        // verify the required parameter 'name' is set
        if ($name === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $name when calling createOAuthClient'
            );
        }
        // verify the required parameter 'redirectUri' is set
        if ($redirectUri === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $redirectUri when calling createOAuthClient'
            );
        }
        ...
        // form params
        if ($redirectUri !== null) {
            $formParams['redirectUri'] = ObjectSerializer::toFormValue($redirectUri);
        }
        // body params
        $_tempBody = null;
    ...
    {
        return $this->deleteOAuthClientAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function deleteOAuthClientRequest($id)
    {
        ...
        if ($id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling deleteOAuthClient'
            );
        }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSpecAsync()
    {
        return $this->getSpecAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSpecAsyncWithHttpInfo
     *
     * Describes this api
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSpecAsyncWithHttpInfo()
    {
        $returnType = '';
        $request = $this->getSpecRequest();
    ...
    /**
     * Create request for operation 'getSpec'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSpecRequest()
    {
