...
class CurriculumApi
{
    ...
    {
        $returnType = '\Swagger\Client\Model\Curriculum[]';
        $request = $this->getCurriculaRequest($includeProgress);
     ...
     */
    public function getCurriculaAsync($includeProgress = null)
    {
        return $this->getCurriculaAsyncWithHttpInfo($includeProgress)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCurriculaAsyncWithHttpInfo
     *
     * Get Curricula
     *
     * @param  bool $includeProgress Whether to return progress with the curriculum. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCurriculaAsyncWithHttpInfo($includeProgress = null)
    {
        $returnType = '\Swagger\Client\Model\Curriculum[]';
        $request = $this->getCurriculaRequest($includeProgress);
    ...
    /**
     * Create request for operation 'getCurricula'
     *
     * @param  bool $includeProgress Whether to return progress with the curriculum. (optional)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function getCurriculaRequest($includeProgress = null)
    {
        ...
        if ($includeProgress !== null) {
            $queryParams['includeProgress'] = ObjectSerializer::toQueryValue($includeProgress);
        }
    ...
    {
        $returnType = '\Swagger\Client\Model\CurriculumWithProgress[]';
        $request = $this->getUserCurriculumWithProgressRequest();
    ...
    /**
     * Operation getUserCurriculumWithProgressAsync
     *
     * Get Detailed For User
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserCurriculumWithProgressAsync()
    {
        return $this->getUserCurriculumWithProgressAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getUserCurriculumWithProgressAsyncWithHttpInfo
     *
     * Get Detailed For User
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserCurriculumWithProgressAsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\CurriculumWithProgress[]';
        $request = $this->getUserCurriculumWithProgressRequest();
    ...
    /**
     * Create request for operation 'getUserCurriculumWithProgress'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getUserCurriculumWithProgressRequest()
    {
