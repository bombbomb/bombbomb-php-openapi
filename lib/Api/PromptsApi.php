...
class PromptsApi
{
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function updatePrompt($id, $sendMechanism = null, $facebookMessage = null, $twitterMessage = null, $videoId = null, $emailId = null, $subject = null)
    {
        list($response) = $this->updatePromptWithHttpInfo($id, $sendMechanism, $facebookMessage, $twitterMessage, $videoId, $emailId, $subject);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function updatePromptWithHttpInfo($id, $sendMechanism = null, $facebookMessage = null, $twitterMessage = null, $videoId = null, $emailId = null, $subject = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
