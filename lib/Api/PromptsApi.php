...
class PromptsApi
{
     ...
     * @param string $endDate The time frame to complete sending to the list. (required)
     * @param string $promptSubject The prompt subject. (required)
     * @param string $promptBody The prompt script. (required)
     ...
     * @return \Swagger\Client\Model\PromptBotBot
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function createPromptBot($listId, $emailId, $endDate, $promptSubject, $promptBody, $botTypeId, $templateId)
    {
        list($response) = $this->createPromptBotWithHttpInfo($listId, $emailId, $endDate, $promptSubject, $promptBody, $botTypeId, $templateId);
        return $response;
    }
     ...
     * @param string $botTypeId The type of bot to create. (required)
     * @param string $templateId The template used to create the email id. (required)
     * @return Array of \Swagger\Client\Model\PromptBotBot, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function createPromptBotWithHttpInfo($listId, $emailId, $endDate, $promptSubject, $promptBody, $botTypeId, $templateId)
    {
        ...
        if ($endDate === null) {
            throw new \InvalidArgumentException('Missing the required parameter $endDate when calling createPromptBot');
        }
        // verify the required parameter 'promptSubject' is set
        if ($promptSubject === null) {
            throw new \InvalidArgumentException('Missing the required parameter $promptSubject when calling createPromptBot');
        }
        // verify the required parameter 'promptBody' is set
        if ($promptBody === null) {
            throw new \InvalidArgumentException('Missing the required parameter $promptBody when calling createPromptBot');
        }
        ...
        // form params
        if ($promptSubject !== null) {
            $formParams['promptSubject'] = $this->apiClient->getSerializer()->toFormValue($promptSubject);
        }
        // form params
        if ($promptBody !== null) {
            $formParams['promptBody'] = $this->apiClient->getSerializer()->toFormValue($promptBody);
        }
        // form params
        if ($botTypeId !== null) {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\PromptBotBot',
                '/prompts/bots'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\PromptBotBot', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\PromptBotBot', $e->getResponseHeaders());
     ...
     *
     * @param string $id The id of the prompt. (required)
     * @param string $choice The users&#39; selection. Can be: WithVideo, WithEmail, Cancel (required)
     * @param string $videoId The id of the video. (optional)
     * @param string $emailId The id of the video. (optional)
     * @return \Swagger\Client\Model\VideoEmailPrompt
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function respondToVideoEmailPrompt($id, $choice, $videoId = null, $emailId = null)
    {
        list($response) = $this->respondToVideoEmailPromptWithHttpInfo($id, $choice, $videoId, $emailId);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function respondToVideoEmailPromptWithHttpInfo($id, $choice, $videoId = null, $emailId = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
     ...
     * @param string $emailId The default email to use. (optional)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function updatePromptBot($id, $emailId = null, $endDate = null, $status = null)
    {
        list($response) = $this->updatePromptBotWithHttpInfo($id, $emailId, $endDate, $status);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function updatePromptBotWithHttpInfo($id, $emailId = null, $endDate = null, $status = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function updatePromptCampaign($clientGroupId, $brandedTemplateId = null, $personalTemplateId = null, $enabled = null)
    {
        list($response) = $this->updatePromptCampaignWithHttpInfo($clientGroupId, $brandedTemplateId, $personalTemplateId, $enabled);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function updatePromptCampaignWithHttpInfo($clientGroupId, $brandedTemplateId = null, $personalTemplateId = null, $enabled = null)
    {
