...
class TeamsApi
{
    ...
    public function addTeamMemberWithHttpInfo($teamId, $admin = null, $subgroupIds = null, $userEmail = null, $userId = null)
    {
        ...
        // form params
        if ($subgroupIds !== null) {
            $formParams['subgroupIds'] = $this->apiClient->getSerializer()->toFormValue($subgroupIds);
        }
        // form params
        if ($userEmail !== null) {
    ...
    {
        list($response) = $this->addUsersWithHttpInfo($teamId, $userDetails, $sendWelcomeEmail, $subgroupIds);
        return $response;
    }
    ...
    public function addUsersWithHttpInfo($teamId, $userDetails, $sendWelcomeEmail = null, $subgroupIds = null)
    {
        // verify the required parameter 'teamId' is set
        if ($teamId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $teamId when calling addUsers');
        }
        // verify the required parameter 'userDetails' is set
        if ($userDetails === null) {
            throw new \InvalidArgumentException('Missing the required parameter $userDetails when calling addUsers');
        }
        // parse inputs
        ...
        // form params
        if ($userDetails !== null) {
            $formParams['userDetails'] = $this->apiClient->getSerializer()->toFormValue($userDetails);
        }
        // form params
        if ($sendWelcomeEmail !== null) {
            $formParams['sendWelcomeEmail'] = $this->apiClient->getSerializer()->toFormValue($sendWelcomeEmail);
        }
        // form params
        if ($subgroupIds !== null) {
            $formParams['subgroupIds'] = $this->apiClient->getSerializer()->toFormValue($subgroupIds);
    ...
    {
        list($response) = $this->addUsersFromCsvWithHttpInfo($teamId, $csvImportId, $map, $sendWelcomeEmail, $subgroupIds);
        return $response;
    }
    ...
    public function addUsersFromCsvWithHttpInfo($teamId, $csvImportId, $map, $sendWelcomeEmail = null, $subgroupIds = null)
    {
        // verify the required parameter 'teamId' is set
        if ($teamId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $teamId when calling addUsersFromCsv');
        }
        // verify the required parameter 'csvImportId' is set
        if ($csvImportId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $csvImportId when calling addUsersFromCsv');
        }
        // verify the required parameter 'map' is set
        if ($map === null) {
            throw new \InvalidArgumentException('Missing the required parameter $map when calling addUsersFromCsv');
        }
        // parse inputs
        ...
        // form params
        if ($csvImportId !== null) {
            $formParams['csvImportId'] = $this->apiClient->getSerializer()->toFormValue($csvImportId);
        }
        // form params
        if ($map !== null) {
            $formParams['map'] = $this->apiClient->getSerializer()->toFormValue($map);
        }
        // form params
        if ($sendWelcomeEmail !== null) {
            $formParams['sendWelcomeEmail'] = $this->apiClient->getSerializer()->toFormValue($sendWelcomeEmail);
    ...
    {
        list($response) = $this->getTeamPromptCampaignsWithHttpInfo($clientGroupId, $searchTerm, $currentPage);
        return $response;
    }
    ...
    {
        list($response) = $this->inviteToSocialPromptTeamWithHttpInfo($teamId, $listId);
        return $response;
    }
    ...
    public function inviteToSocialPromptTeamWithHttpInfo($teamId, $listId)
    {
        // verify the required parameter 'teamId' is set
        if ($teamId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $teamId when calling inviteToSocialPromptTeam');
        }
        // verify the required parameter 'listId' is set
        if ($listId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $listId when calling inviteToSocialPromptTeam');
        }
        // parse inputs
    ...
    public function updateTeamWithHttpInfo($teamId, $name = null, $state = null, $subteamsCanAddMembers = null)
    {
        ...
        if ($subteamsCanAddMembers !== null) {
            $formParams['subteamsCanAddMembers'] = $this->apiClient->getSerializer()->toFormValue($subteamsCanAddMembers);
        }
    ...
    {
        list($response) = $this->updateTeamMemberWithHttpInfo($teamId, $userId, $admin, $permissionSuiteId);
        return $response;
    }
    ...
    public function updateTeamMemberWithHttpInfo($teamId, $userId, $admin, $permissionSuiteId = null)
    {
        ...
        if ($permissionSuiteId !== null) {
            $formParams['permissionSuiteId'] = $this->apiClient->getSerializer()->toFormValue($permissionSuiteId);
        }
