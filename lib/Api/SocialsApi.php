...
class SocialsApi
{
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getSocialArticleProperties($emailId)
    {
        list($response) = $this->getSocialArticlePropertiesWithHttpInfo($emailId);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getSocialArticlePropertiesWithHttpInfo($emailId)
    {
