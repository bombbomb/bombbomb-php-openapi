...
class AccountsApi
{
    ...
    {
        list($response) = $this->getClientStatisticsWithHttpInfo($clientId, $refresh, $statisticValues);
        return $response;
    }
    ...
    public function getClientStatisticsWithHttpInfo($clientId = null, $refresh = null, $statisticValues = null)
    {
        ...
        if ($statisticValues !== null) {
            $queryParams['statisticValues'] = $this->apiClient->getSerializer()->toQueryValue($statisticValues);
        }
        // default format to json
        $resourcePath = str_replace("{format}", "json", $resourcePath);
    ...
    {
        list($response) = $this->getUserCountryWithHttpInfo();
        return $response;
    }
    ...
    {
        list($response) = $this->resetApiKeyWithHttpInfo();
        return $response;
    }
    ...
    {
        list($response) = $this->updateProfileDataWithHttpInfo($profileData);
        return $response;
    }
    ...
    public function updateProfileDataWithHttpInfo($profileData = null)
    {
        ...
        // form params
        if ($profileData !== null) {
            $formParams['profileData'] = $this->apiClient->getSerializer()->toFormValue($profileData);
        }
