...
class UtilitiesApi
{
    ...
    {
        list($response) = $this->createOAuthClientWithHttpInfo($name, $redirect_uri);
        return $response;
    }
    ...
    public function createOAuthClientWithHttpInfo($name, $redirect_uri)
    {
        ...
        if ($redirect_uri === null) {
            throw new \InvalidArgumentException('Missing the required parameter $redirect_uri when calling createOAuthClient');
        }
        // parse inputs
        ...
        // form params
        if ($redirect_uri !== null) {
            $formParams['redirectUri'] = $this->apiClient->getSerializer()->toFormValue($redirect_uri);
        }
